...
class DeviceEntityMapper:
    ...
    def add_capability(
        ...
        if "title" not in options and _current_entity is not None:
...
def _get_mappers() -> dict[type[EntityInfo], _EntityMapper]:
    ...
    from homey_esphomedriver.mapping.alarm_control_panel import (
        AlarmControlPanelEntityMapper,
    )
    from homey_esphomedriver.mapping.binary_sensor import (
        BinarySensorEntityMapper,
    )
    from homey_esphomedriver.mapping.button import (
        ButtonEntityMapper,
    )
    from homey_esphomedriver.mapping.climate import (
        ClimateEntityMapper,
    )
    from homey_esphomedriver.mapping.cover import (
        CoverEntityMapper,
    )
    from homey_esphomedriver.mapping.event import (
        EventEntityMapper,
    )
    from homey_esphomedriver.mapping.fan import (
        FanEntityMapper,
    )
    from homey_esphomedriver.mapping.light import (
        LightEntityMapper,
    )
    from homey_esphomedriver.mapping.lock import (
        LockEntityMapper,
    )
    from homey_esphomedriver.mapping.media_player import (
        MediaPlayerEntityMapper,
    )
    from homey_esphomedriver.mapping.number import (
        NumberEntityMapper,
    )
    from homey_esphomedriver.mapping.select import (
        SelectEntityMapper,
    )
    from homey_esphomedriver.mapping.sensor import (
        SensorEntityMapper,
    )
    from homey_esphomedriver.mapping.siren import (
        SirenEntityMapper,
    )
    from homey_esphomedriver.mapping.switch import (
        SwitchEntityMapper,
    )
    from homey_esphomedriver.mapping.text_sensor import (
        TextSensorEntityMapper,
    )
    from homey_esphomedriver.mapping.valve import (
        ValveEntityMapper,
    )
    from homey_esphomedriver.mapping.water_heater import (
